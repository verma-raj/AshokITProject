...
script {
		  ...
		  { stage ("git-clone")
		   	...
		   	checkout([$class: 'GitSCM', branches: [[name: env.branch]], extensions: [], userRemoteConfigs: [[credentialsId: 'rajiv-github', url: 'https://github.com/verma-raj/AshokITProject.git']]])
